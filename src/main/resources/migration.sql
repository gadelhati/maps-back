...
--time: 21s
INSERT INTO maps.sedimentological_analysis
(id, created_at, updated_at, cod_amostra_geologica, num_analise, b, co, cod_laboratorio, cr, data_analise, data_remessa, e, espessura, f, floculacao, g, gc, idade_geologica, l, maturidade, metodo_analise_mineral, metodo_datacao, metodologia_c1, metodologia_c2, metodologia_d1, metodologia_d2, metodologia_e, metodologia_f, metodologia_m1, metodologia_m2, metodologia_p1, metodologia_p2, metodologia_r, metodologia_t, morfom_a, morfom_e, morfom_f, o1, o2, p, s, peso_analise, percentual_carbonato, obs_analise, per_05_dist_gran, per_16_dist_gran, per_25_dist_gran, per_50_dist_gran, per_75_dist_gran, per_84_dist_gran, per_95_dist_gran, par_assimetria, par_curtose, par_desvio_padrao, par_diametro_medio, par_mediana, per_areia, per_argila, per_cascalho, per_silte, cod_banco, num_arquivo, comprimento_coletado)
SELECT uuid_generate_v4()::UUID, now(), now(), cod_amostra_geologica, tas.num_analise, tas.b, tas.co, tas.cod_laboratorio, tas.cr, tas.data_analise, tas.data_remessa, tas.e, tas.espessura, tas.f, tas.floculacao, tas.g, tas.gc, tas.idade_geologica, tas.l, tas.maturidade, tas.metodo_analise_mineral, tas.metodo_datacao, tas.metodologia_c1, tas.metodologia_c2, tas.metodologia_d1, tas.metodologia_d2, tas.metodologia_e, tas.metodologia_f, tas.metodologia_m1, tas.metodologia_m2, tas.metodologia_p1, tas.metodologia_p2, tas.metodologia_r, tas.metodologia_t, tas.morfom_a, tas.morfom_e, tas.morfom_f, tas.o1, tas.o2, tas.p, tas.s, tas.peso_analise, tas.percentual_carbonato, tas.obs_analise, tas.per_05_dist_gran, tas.per_16_dist_gran, tas.per_25_dist_gran, tas.per_50_dist_gran, tas.per_75_dist_gran, tas.per_84_dist_gran, tas.per_95_dist_gran, tas.par_assimetria, tas.par_curtose, tas.par_desvio_padrao, tas.par_diametro_medio, tas.par_mediana, tas.per_areia, tas.per_argila, tas.per_cascalho, tas.per_silte, tas.cod_banco, tas.num_arquivo, tas.comprimento_coletado
FROM sisbndo.tb_analise_sedimentologica tas
LEFT JOIN maps.geological_sample gs ON tas.cod_amostra_geologica = gs.cod_geological_sample::BIGINT
ON CONFLICT (id) DO NOTHING;