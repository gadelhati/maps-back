    ...
    public SecurityFilterChain filterChain(HttpSecurity httpSecurity) throws Exception {
        httpSecurity
                ...
                .authorizeHttpRequests((auth) -> auth
                        ...
                        .requestMatchers(HttpMethod.POST, "/auth/**", "/signup", "/signin", "/requiredPassword", "/requiredTotp", "/signup2", "/user/resetPassword", "/user/resetSecret").permitAll()
                        .requestMatchers(HttpMethod.PUT, "/user/resetPassword", "/user/resetSecret").permitAll()
